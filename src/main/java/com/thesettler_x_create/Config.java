...
public class Config {
    ...
    public static final ModConfigSpec.IntValue PERMA_MIN_BUILDING_LEVEL = BUILDER
            .comment("Minimum Create Shop level required for perma requests.")
            .defineInRange("permaMinBuildingLevel", 2, 1, 5);

    public static final ModConfigSpec.LongValue PERMA_REQUEST_INTERVAL_TICKS = BUILDER
            .comment("Ticks between perma request evaluations.")
            .defineInRange("permaRequestIntervalTicks", 200L, 20L, 24000L);

    public static final ModConfigSpec.DoubleValue SHOPKEEPER_WORK_RADIUS = BUILDER
    ...
    public static final ModConfigSpec.LongValue MISSING_NETWORK_WARNING_COOLDOWN = BUILDER
    ...
    public static final ModConfigSpec.LongValue PENDING_NOTICE_COOLDOWN = BUILDER
            .comment("Cooldown (ticks) for pending delivery notices.")
            .defineInRange("pendingNoticeCooldown", 20L * 10L, 20L, 24000L);

    public static final ModConfigSpec.LongValue DELIVERY_ASSIGNMENT_DEBUG_COOLDOWN = BUILDER
    ...
    public static final ModConfigSpec.LongValue TICK_PENDING_DEBUG_COOLDOWN = BUILDER
