...
public final class ModItems {
  ...
  public static final DeferredRegister.Items ITEMS =
      DeferredRegister.createItems(TheSettlerXCreate.MODID);
  public static final DeferredItem<Item> NETWORK_LINK_TUNER =
      ITEMS.register(
          "network_link_tuner", () -> new StockLinkLinkerItem(new Item.Properties().stacksTo(1)));
  public static final DeferredItem<Item> HUT_CREATE_SHOP =
      ITEMS.register(
          "blockhutcreateshop",
          () -> new ItemBlockHut(ModBlocks.HUT_CREATE_SHOP.get(), new Item.Properties()));
  public static final DeferredItem<Item> CREATE_SHOP_PICKUP =
      ITEMS.register(
          "create_shop_pickup",
          () -> new BlockItem(ModBlocks.CREATE_SHOP_PICKUP.get(), new Item.Properties()));
