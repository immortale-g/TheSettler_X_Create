...
public final class BlueprintFixer {
    ...
    static int run(String[] args, PrintStream out, PrintStream err) {
        ...
        try {
            ...
            err.println("Failed to read blueprint NBT: " + (ex.getMessage() == null ? "<unknown>" : ex.getMessage()));
            return 5;
        }
        ...
        try {
            ...
            err.println("Failed to write blueprint NBT: " + (ex.getMessage() == null ? "<unknown>" : ex.getMessage()));
            return 6;
        }
        out.println("Fixed blueprint: " + path + " (schematicName " + oldName + " -> " + baseName + ", level=" + levelArg + ")");
        return 0;
    }
