...
/**
 * Small warehouse-stock query shared by any Create Shop flow that needs to know how much of an
 * item the colony's warehouses hold before placing a request against them - both the (disabled)
