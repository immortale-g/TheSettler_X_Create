  ...
  public void onRequestedRequestComplete(final IRequestManager manager, final IRequest<?> request) {
    ...
    if (Config.DEBUG_LOGGING.getAsBoolean()
      ...
      try {
        ...
        IRequest<?> parent =
            parentToken == null || handler == null ? null : handler.getRequest(parentToken);
        ...
        if (handler != null && parent != null && parentChildren) {
          ...
          if (containsChild && FORCE_COMPLETE_LOGGED.add(key)) {
            try {
              ...
              String parentStateAfter =
                  parentAfter == null ? "<null>" : String.valueOf(parentAfter.getState());
              int childCountAfter =
                  parentAfter == null || parentAfter.getChildren() == null
                      ? 0
