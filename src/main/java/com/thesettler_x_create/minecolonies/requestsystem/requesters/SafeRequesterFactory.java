...
/**
 * Legacy compatibility factory for old worlds that still contain SafeRequester serialized entries.
 *
 * <p>Note: new request flow no longer wraps native requesters with this class.
 */
