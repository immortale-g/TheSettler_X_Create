 ...
 * with traceable request and delivery flows (the README says so too). Seam-audit findings s3-7/s4-4
 * still apply: the 1.0.0 release commit flips this to {@code false}, together with this test and
 * the README note.
 */
