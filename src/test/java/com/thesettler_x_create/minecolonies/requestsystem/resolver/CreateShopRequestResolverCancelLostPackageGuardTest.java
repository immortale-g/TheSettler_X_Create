...
class CreateShopRequestResolverCancelLostPackageGuardTest {
  @Test
  void cancelledRequestReleaseAlsoClearsLostPackageInflightEntries() throws Exception {
    String source =
        Files.readString(
            Path.of(
    ...
    assertTrue(source.contains("shop.cancelLostPackage("));
  }
}
