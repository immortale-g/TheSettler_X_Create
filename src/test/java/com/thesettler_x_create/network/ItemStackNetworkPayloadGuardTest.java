...
/**
 * Source-text guards for the payload carrying item stacks ({@code CreateShopBatchRequestPayload}).
 * ItemStack's own STREAM_CODEC throws outside a bootstrapped game instance (confirmed empirically -
 * this project deliberately never bootstraps registries in tests), so unlike {@link
 * NetworkPayloadRoundTripTest} these can't be exercised as live round-trips; this locks in
 * encode/decode field-order symmetry instead.
 */
